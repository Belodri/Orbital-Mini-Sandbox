...
- 08/11/2025 - Add `DOMEventManager` for dynamic DOM event delegation via declarative data-* attributes (`data-on:<event_type>="<component_id>:<handler>"`), so components don't have to worry about managing the lifecycle of listeners.